                                ...
                                <tbody>
                                    @foreach ($estudiantes as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->Nombres }} {{ $item->Apellidos }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <select class="form-control-sm" name="idBimestre[]">
                                                    ...
                                                    @foreach ($bimestres as $bimestre)
                                                        <option value="{{ $bimestre->id }}">{{ $bimestre->descripcion }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td>
                                                <input type="file" class="form-control form-control-sm" lang="en"
                                                    name="Boleta[]">
                                            </td>
                                        </tr>
                                    @endforeach
